namespace KuzApps.Application.Interfaces.Base;
...
public interface IRepo<T, TKey> where T : IEntity<TKey>
{
    /// <summary>
    ...
    Task<IPage<T>> GetPage(int pageNumber, int pageSize, CancellationToken cancel);
...
/// <summary>
/// Репозиторий сущностей с целочисленных идентфикатором
/// </summary>
/// <typeparam name="T">Тип элементов</typeparam>
public interface IRepo<T> : IRepo<T, int> where T : IEntity<int> { }
